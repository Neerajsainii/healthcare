...
urlpatterns = [
    ...
    path("adminLogin/", client_views.AdminLoginView.as_view(), name="adminLogin"),
    path("Signup/", client_views.signup, name="signup"),
    path("doctorLogin/", client_views.DoctorLoginView.as_view(), name="doctorLogin"),
    path("Signup/", client_views.signup, name="signup"),
    path("medicalpractitionerLogin/", client_views.MedicalPractitionerLoginView.as_view(), name="medicalLogin"),
    ...
    path("w/", (medicalpractitioner_views.whome), name="whome"),
    path("wabout/", (medicalpractitioner_views.wabout), name="wabout"),
    path("wcontact/", (medicalpractitioner_views.wcontact), name="wcontact"),
    path("wemergency/", (medicalpractitioner_views.wemergency), name="wemergency"),
    path("wsymptom/", (medicalpractitioner_views.wSymptom), name="wsymptom"),
    path("wsymptoms/", (medicalpractitioner_views.wsymptoms), name="wsymptoms"),
    # path("wtreatment/", (medicalpractitioner_views.wtreatment), name="wtreatment"),
    # path("wdisease/", (medicalpractitioner_views.wdisease), name="wdisease"),
    path("wprecaution/", (medicalpractitioner_views.wprecaution), name="wprecaution"),
    path("winfant/", (medicalpractitioner_views.winfant), name="winfant"),
    path("wchild/", (medicalpractitioner_views.wchild), name="wchild"),
    path("wbmi/", (medicalpractitioner_views.wbmi), name="wbmi"),
